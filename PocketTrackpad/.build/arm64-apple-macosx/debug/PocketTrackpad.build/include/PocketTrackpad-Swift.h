...
#ifndef POCKETTRACKPAD_SWIFT_H
#define POCKETTRACKPAD_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PocketTrackpad",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_CLASS("_TtC14PocketTrackpad20HIDPeripheralManager")
@interface HIDPeripheralManager : NSObject
...
@class CBATTRequest;
@class NSString;
@interface HIDPeripheralManager (SWIFT_EXTENSION(PocketTrackpad)) <CBPeripheralManagerDelegate>
